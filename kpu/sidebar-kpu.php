            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="dashboard-kpu.php"
                        ...
                        <span class="ms-3">Lihat Data Kades</span>
                    </a>
                </li>
                <li>
                    <a href="lihat-voter.php"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Lihat Data User</span>
                        <span
                ...
                <li>
                    <a href="lihat-jadwal.php"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Atur Jadwal Pemilu</span>
                        <span
                ...
                <li>
                    <a href="hasil-pemilu.php"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Hasil Pemilu</span>
                        <span
                            class="inline-flex items-center justify-center w-3 h-3 p-3 ms-3 text-sm font-medium text-blue-800 bg-blue-100 rounded-full dark:bg-blue-900 dark:text-blue-300">3</span>
                    </a>
                </li>
