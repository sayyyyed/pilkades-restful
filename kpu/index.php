        ...
        <div class="py-8 px-4 mx-auto max-w-screen-xl  lg:py-16 z-10 relative">
            <div class="flex items-center justify-center flex-col">
                ...
                <div class="flex items-center mb-3"> <!-- Center horizontally -->
                    ...
                    <div class="flex flex-col"> <!-- Center horizontally and vertically for the text div -->
                        <span class="text-x4 whitespace-nowrap dark:text-white">Lembaga KPU</span>
                        <span class="text-x4 font-extrabold whitespace-nowrap dark:text-white">Kecamatan Istanbul</span>
                    </div>
                </div>
            ...
            <div
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" action="proses-kpu-login.php" method="POST">
