...
if (!isset($_COOKIE['jwt'])) {
    ...
    $data = array("jwt" => $_COOKIE['jwt'], "nik" => $_COOKIE['nik'], "domisili" => $_COOKIE['domisili'],"id_kades"=> $_COOKIE['id_kades']);
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        ...
                        <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Pilkades
                            Online</span>
                    </a>
                </div>
                    ...
                    <div class="flex items-center ms-3">
                        ...
                        <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600"
                            ...
                            <ul class="py-1" role="none">
                                ...
                                <li>
                                <form action="proses-kades.php" method="GET">
            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="dashboard-kades.php"
                        ...
                        <span class="ms-3">Profil Calon</span>
                    </a>
                </li>
                <li>
                    <a href="visi-kades.php"
                        class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Visi Calon</span>
                        <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">Penting</span>
                    </a>
                </li>
