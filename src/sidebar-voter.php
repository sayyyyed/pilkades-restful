            ...
            <ul class="space-y-2 font-medium">
                <li>
                    <a href="dashboard-voter.php"
                        ...
                        <span class="ms-3">Profil Pemilih</span>
                    </a>
                </li>
                <li>
                    <a href="lihat-paslon.php"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Lihat Paslon</span>
                        <span
                ...
                <li>
                    <a href="bilik-suara.php"
                        ...
                        <span class="flex-1 ms-3 whitespace-nowrap">Bilik Suara</span>
                        <span
